...
// Extract exactly the body to keep Next.js happy
const bodyMatch = html.match(/<body>(.*)<\/body>/s);
let bodyContent = bodyMatch ? bodyMatch[1] : '';
bodyContent = bodyContent.replace(/<script src="app\.js"><\/script>/, '');

fs.writeFileSync(path.join(__dirname, 'app/home.html'), bodyContent);
console.log('Successfully generated app/home.html bypassing literal strings');
