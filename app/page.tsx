...
export default function WaitlistPage() {
  ...
  const handleSubmitStep2 = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setStatus("success");
        setMessage("Thank you! Your registration is complete.");
      }
    } catch (err) {
      setStatus("error");
      setMessage("Connection error. Please try again.");
  ...
  return (
    <div className={styles.page}>
      ...
      {/* Adjusted Lighter Overlay */}
      <div className={styles.overlay} aria-hidden />

      {/* Top Left Header (Logo and Brand Copy) */}
      ...
      {/* Bottom Center Registration Form */}
      <div className={styles.contentContainer}>
        <div className={styles.registrationBox}>
          ...
          {step === 1 ? (
            ...
            <form onSubmit={handleSubmitStep2} className={styles.formBox}>
              ...
              <button 
                ...
                disabled={status === "loading" || status === "success"}
              >
                <span>{status === "loading" ? "Saving..." : status === "success" ? "Complete!" : "Complete Registration"}</span>
          ...
          {/* Social Icons row (always visible at bottom inside registration box) */}
